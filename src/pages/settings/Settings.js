      ...
      <Topbar title="Nastavení">
        <ul className={settingsStyle.navigation}>
          <li
            ...
            className={settingsStyle.navigation_item + " " + (activeButton === "fontSize" ? settingsStyle.navigation_item_active : "")}
          >
          ...
          <li
            ...
            className={settingsStyle.navigation_item + " " + (activeButton === "fontLine" ? settingsStyle.navigation_item_active : "")}
          >
          ...
          <li
            ...
            className={settingsStyle.navigation_item + " " + (activeButton === "fontAlign" ? settingsStyle.navigation_item_active : "")}
          >
