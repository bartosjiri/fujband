  ...
  return (
    <nav className={navbarStyle.navbar}>
      <ul>
        ...
        <li>
          <NavLink to={(currentSong !== undefined && currentSong.slug) ? `/songs/${currentSong.slug}` : "/songs"} exact className={navbarStyle.item} activeClassName={navbarStyle.item_active}>
